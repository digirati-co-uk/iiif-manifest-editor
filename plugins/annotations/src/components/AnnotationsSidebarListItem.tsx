import { ActionButton, CheckIcon, DeleteIcon, EditTextIcon, HTMLAnnotationBodyRender } from "@manifest-editor/components";
...
export function AnnotationsSidebarListItem() {
  ...
  const isBodyEmpty = !annotation || bodies.length === 0;
    ...
    <div {...highlightProps} className="border border-gray-300 hover:border-me-500 shadow-sm rounded bg-white relative">
      <div className="relative">
        {annotationTarget ? (
          ...
          <div className="flex items-center justify-center px-4 py-6 text-gray-400 text-sm">This annotation has no body.</div>
        ) : isOpen ? (
      ...
      <div className="flex gap-2 p-2">
        {annotationTarget ? (
          <ActionButton onPress={() => edit({ id: annotationTarget, type: "Annotation" }, undefined, { forceOpen: true })}>
