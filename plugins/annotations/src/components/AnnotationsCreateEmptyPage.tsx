      ...
      <SidebarContent>
        <div className="flex flex-col items-center justify-center p-4">
          <div className="p-4 opacity-50 text-center">
            This canvas does not yet have any inline annotations. To add inline annotations, an AnnotationPage is created
            which will be linked to this canvas, and can then used to add your annotations. Simply use the link below to
            start adding your annotations
          </div>

          <ActionButton large primary onPress={() => createEmptyAnnotationPage()}>
