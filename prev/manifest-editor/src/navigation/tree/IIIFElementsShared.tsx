...
export const KeyManifest = styled(Key)`
  background: ${(props: any) => props.theme.iiifColor.manifest || "rgba(0, 0, 0, 0.2)"};
`;

export const KeyCanvas = styled(Key)`
  background: ${(props: any) => props.theme.iiifColor.canvas || "rgba(255, 222, 219, 0.8)"};
`;
...
export const KeyContentResource = styled(Key)`
  background: ${(props: any) => props.theme.iiifColor.contentResource || "rgba(207, 247, 255, 0.8)"};
`;

export const KeyRanges = styled(Key)`
  background: ${(props: any) => props.theme.iiifColor.ranges || "rgba(144, 213, 157, 0.8)"};
`;
...
export const Expanded = styled.div`
  ...
  .parent:hover .child {
    background-color: ${(props: any) => props.theme.color.lightgrey || "lightgrey"};
    border-bottom: 1px solid ${(props: any) => props.theme.color.white || "white"};
  }
`;
...
export const KeyValuePairString: React.FC<KeyString> = ({ propertyName, value, onClick }) => {
  return (
