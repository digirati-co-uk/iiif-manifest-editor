...
export function CreatorGrid(props: { label: string; items: CreatorGridItemProps[] }) {
  return (
    <ListBox
      ...
      items={props.items}
      className="grid grid-sm gap-4 p-4"
    >
...
function CreatorGridItem(props: CreatorGridItemProps) {
  return (
    ...
    >
      <div className="rounded bg-me-gray-300 mb-2 flex items-center justify-center py-1">
