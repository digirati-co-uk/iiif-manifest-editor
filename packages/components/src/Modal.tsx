      ...
      >
        ...
        >
          <div className="flex items-center justify-between gap-3 p-4 rounded-t-lg sticky top-0 bg-white">
            ...
            <button
              type="button"
              className="text-gray-600 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-me-primary-500 focus-visible:ring-offset-2"
              onClick={onClose}
            >
              <svg
                className="w-3 h-3"
