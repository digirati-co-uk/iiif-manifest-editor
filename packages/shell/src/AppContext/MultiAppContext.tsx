...
import { useOptionalLocalStorage } from "@manifest-editor/components";
...
export function MultiAppProvider({
  ...
  const {
    defaultApp = "splash",
    collectionApp = "collection-editor",
    manifestApp = "manifest-editor",
  } = config;
  ...
  return (
    ...
    >
      <MultiAppContext.Provider value={ctx}>
        {children}
