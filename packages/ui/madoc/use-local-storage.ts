  ...
  const setValue = (value: ((prev: T) => T) | T) => {
    try {
      if (typeof window !== "undefined" && typeof window.localStorage !== "undefined") {
        ...
        try {
          prev = typeof lastStoredValue.current === "undefined" ? initialValue : JSON.parse(lastStoredValue.current);
        } catch (e) {}

        // Allow value to be a function so we have same API as useState
        const valueToStore = value instanceof Function ? value(prev as any) : value;
