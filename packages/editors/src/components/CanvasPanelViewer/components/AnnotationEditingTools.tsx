...
import { useSvgTools } from "../hooks/use-svg-tools";
import {
  CircleIcon,
  CusorIcon,
  DeleteForeverIcon,
...
export function AnnotationEditingTools() {
  ...
  const toolType = useStore(store, (s) => s.toolType);
