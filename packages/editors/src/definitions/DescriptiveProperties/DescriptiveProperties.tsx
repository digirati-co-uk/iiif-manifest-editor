...
import { ActionButton, AddIcon, EmptyState, PaddedSidebarContainer } from "@manifest-editor/components";
...
export function DescriptiveProperties() {
  ...
  const [canCreateProvider, providerActions] = useCreator(resource?.resource, "provider", "Manifest");
