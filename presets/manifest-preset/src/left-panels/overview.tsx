import { LayoutPanel, useLayoutActions } from "@manifest-editor/shell";
import { SVGProps, useEffect } from "react";

function HomeIcon({ title, titleId, ...props }: SVGProps<SVGSVGElement> & { title?: string; titleId?: string }) {
  return (
