...
import { CanvasListView, CanvasListingIcon } from "@manifest-editor/manifest-preset/components";
import { type LayoutPanel, useCreator, useManifestEditor } from "@manifest-editor/shell";
  ...
  return (
    <Sidebar>
      <SidebarHeader
        ...
        actions={[
          {
            icon: toggled.list ? <CanvasListingIcon className="text-2xl" /> : <ExhibitionGridIcon />,
