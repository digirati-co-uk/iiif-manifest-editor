...
import { MediaResourceEditor } from "../components/form/MediaResourceEditor";
...
MediaResourceEditorEmpty.args = {
  thumbnailSrc:
    "https://iiif.wellcomecollection.org/thumbs/b28658401_0005.jp2/full/58,100/0/default.jpg",
};
