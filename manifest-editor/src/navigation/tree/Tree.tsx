  ...
  return (
    <TreeContainer key={manifest?.id}>
      <HeaderPanel onClick={() => setOpen(!open)}>
        <FlexContainer>
          <KeyManifest onClick={editorContext ? () => editorContext.changeSelectedProperty("manifest") : () => {}}>
            {manifest?.type}
          </KeyManifest>
      ...
      {open && (
        <>
          <KeyObjectPairing
            onClick={editorContext ? () => editorContext.changeSelectedProperty("manifest", 0) : () => {}}
            propertyName={"label"}
            object={manifest?.label || {}}
          />
          <Annotations
            onClick={editorContext ? () => editorContext.changeSelectedProperty("annotations") : () => {}}
            propertyName={"annotations"}
            array={manifest?.annotations || []}
          />
          <KeyValuePairArray
            onClick={editorContext ? () => editorContext.changeSelectedProperty("manifest", 1) : () => {}}
            propertyName={"behavior"}
            array={manifest?.behavior || []}
          />
          <KeyValuePairArray
            onClick={editorContext ? () => editorContext.changeSelectedProperty("manifest", 2) : () => {}}
          ...
          <KeyValuePairArray
            // @ts-ignore
            key={manifest}
            onClick={editorContext ? () => editorContext.changeSelectedProperty("manifest", 4) : () => {}}
            propertyName={"items"}
            // @ts-ignore
          ...
          <KeyValuePairArray
            onClick={editorContext ? () => editorContext.changeSelectedProperty("logo") : () => {}}
            propertyName={"logo"}
            array={manifest?.logo || []}
          />
          <KeyObjectPairing
          ...
          />
          <KeyObjectPairing
            onClick={editorContext ? () => editorContext.changeSelectedProperty("motivation") : () => {}}
          ...
          />
          <KeyObjectPairing
            onClick={editorContext ? () => editorContext.changeSelectedProperty("posterCanvas") : () => {}}
            propertyName={"posterCanvas"}
            object={manifest?.posterCanvas || {}}
          />
          <KeyObjectPairing
            onClick={editorContext ? () => editorContext.changeSelectedProperty("accompanyingCanvas") : () => {}}
            propertyName={"accompanyingCanvas"}
            object={manifest?.accompanyingCanvas || {}}
          />
          <KeyObjectPairing
            onClick={editorContext ? () => editorContext.changeSelectedProperty("placeholderCanvas") : () => {}}
          ...
          />
          <KeyValuePairArray
            onClick={editorContext ? () => editorContext.changeSelectedProperty("manifest", 3) : () => {}}
          ...
          />
          <KeyValuePairArray
            onClick={editorContext ? () => editorContext.changeSelectedProperty("thumbnail") : () => {}}
          ...
          />
          <KeyValuePairString
            onClick={editorContext ? () => editorContext.changeSelectedProperty("@context") : () => {}}
