              ...
              <ContainerColumn>
                {array.map((val: any) => {
                  if (val && val.type === "ContentResource") {
                    return <ContentResources propertyName="ContentResource" object={val} onClick={() => {}} />;
                  } else if (val && val.type === "Canvas") {
                    return (
                      <Canvases
                        propertyName="ContentResource"
                        object={val}
                        onClick={() => editorContext?.changeSelectedProperty("canvas")}
                      />
                    );
                  } else if (propertyName === "services") {
                    return <Services propertyName="Services" object={val} onClick={() => {}} />;
                  } else if (propertyName === "service") {
                    return <IIIFService propertyName="Services" object={val} onClick={() => {}} />;
                  } else if (val && val.type === "Range") {
                    return <Ranges propertyName="Range" object={val} onClick={() => {}} />;
