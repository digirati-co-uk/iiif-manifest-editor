...
const UniversalViewer: React.FC<UniversalViewerProps> = React.memo(
  ({ manifestId = "https://view.nls.uk/manifest/1227/7148/122771487/manifest.json", canvasIndex, onChangeCanvas }) => {
    ...
    return (
      <>
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/universalviewer@4.0.0-pre.66/dist/esm/index.css" />
