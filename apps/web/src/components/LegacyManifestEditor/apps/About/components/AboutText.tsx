  ...
  return (
    <div>
      <div>
        ...
        <p>
          Use the links below to start exploring existing IIIF Manifests, or open any Manifest on the web if you have a
          URL.
        </p>
        <p>You can also pick from common templates to get started making your own Manifests.</p>
      </div>
    </div>
  );
});
