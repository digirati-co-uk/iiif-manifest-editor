...
import { type DocHeading } from "../../contentlayer/Doc";
import { getNodeText, sluggifyTitle } from "../../contentlayer/utils/slugs";

export function PageNavigation({ headings }: { headings: DocHeading[] }) {
      ...
      <ul className="space-y-2">
        {headingsToRender.map(({ title, level }, index) => (
          <li key={index}>
            ...
            >
              <span className="mr-2 mt-[5px] block w-1.5 shrink-0">{/* <Icon name="chevron-right" /> */}</span>
              <span
