---
title: Creating a book from Image Services and Static Images.
nav_title: Creating a book
excerpt: The goal of this test is to create a Manifest for a book out of existing, hosted IIIF Image Services.
---
...
[https://manifest-editor-testing.netlify.app/](https://manifest-editor-testing.netlify.app/)
