---
title: Assembling images into a Manifest
nav_title: Assembling images
excerpt: The goal of this test is to create a simple manifest out of existing, hosted static images.
---
