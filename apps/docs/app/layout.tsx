...
const navbar = (
  <Navbar
    logo={
      <svg width="200" height="27" viewBox="0 0 206 27" xmlns="http://www.w3.org/2000/svg" className="me-logo">
        <g fill="none">
          <path
            ...
            fill="currentColor"
          ></path>
          <path fill="#E94581" className="me-logo-1" d="M0 13.343 13.343 0l13.343 13.343-13.343 13.343z"></path>
          <path fill="#E94581" className="me-logo-2" d="M12.137 13.346 25.48.003l13.343 13.343L25.48 26.69z"></path>
          <path fill="#C63E75" className="me-logo-3" d="m12.104 13.348 7.311-7.311 7.312 7.311-7.312 7.312z"></path>
        </g>
      </svg>
    }
