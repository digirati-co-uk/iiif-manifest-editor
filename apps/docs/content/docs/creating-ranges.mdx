...
- Create a range item within the IIIF Range labelled ‘Range 1’, in which all Canvases in the open Manifest will be placed

## Viewing and managing the range structure

The left menu panel for the Range Editor provides a number of options when editing a range. By default, the left menu panel displays the hierarchical range structure (tree view).
