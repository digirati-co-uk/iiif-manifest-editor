...
With the initial range in place, you can develop this structure to reflect the Table of Contents you want to use. To start, you can add more range items into the structure, moving the content of your IIIF Manifest into these new range items.

To start, select the option to 'Split range'. 

![Split range](../../public/creating-new-range-2.png)

On selecting the 'Split range' option, the range splitting mode is enabled providing you with the ability to split the content into the required ranges. 
...
Using 'Range 2' example indicated in the previous screenshot, the following steps detail how to move all of the canvases contained within that 'Range 2' into two sub-range items:
...
- This action moves the Canvases into a new sub-range ("Range 1") within Range 2. 
...
![Edit range label](../../public/creating-new-range-9.png)
