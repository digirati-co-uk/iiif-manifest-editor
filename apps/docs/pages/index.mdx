...
- An extensible visual tool for creating and editing IIIF Manifests and more
- Compatible with IIIF Presentation API 2 and 3
- Preview your work as you go in your viewer of choice
- Share your work in progress IIIF Manifests for others to view or create copies to edit
