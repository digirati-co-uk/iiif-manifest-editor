...
As a quick example, the first thing we will do is change the label (or title) of the Manifest. This is usually a prominent title that describes the content of the Manifest.
...
For more details on editing, please see the section [Manifest Editor](./manifest-editing)
