...
This will open a new empty manifest in the editor, where you can start [adding resources](./adding-resources) and [editing the manifest](#basic-editing).
...
The first thing we will do is change the label (or title) of the Manifest. This is usually a prominent title that describes the content of the Manifest.
